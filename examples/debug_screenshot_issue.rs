use earth_engine::{EngineConfig, renderer, Game, Block, BlockId, RenderData, BlockRegistry};
use std::sync::Arc;
...
impl Game for ScreenshotDebugGame {
    ...
    fn update(&mut self, _ctx: &mut earth_engine::GameContext, _delta_time: f32) {
    ...
    fn on_block_break(&mut self, _pos: earth_engine::VoxelPos, _block: BlockId) {}
    fn on_block_place(&mut self, _pos: earth_engine::VoxelPos, _block: BlockId) {}
}
