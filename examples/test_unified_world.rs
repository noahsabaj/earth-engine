...
use hearth_engine::{
    UnifiedWorldManager, UnifiedWorldConfig, UnifiedStorage, UnifiedGenerator,
    ComputeEngine, ChunkManagerInterface, GeneratorInterface,
    VoxelPos, ChunkPos, BlockId,
};
use std::sync::Arc;
...
async fn test_unified_world() {
    ...
    let test_pos = VoxelPos { x: 10, y: 64, z: 10 };
