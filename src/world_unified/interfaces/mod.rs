...
pub enum QueryType {
    ...
    GetBlock { pos: crate::world_unified::core::VoxelPos },
    /// Get surface height at coordinates
    GetSurfaceHeight { x: f64, z: f64 },
    /// Check if chunk is loaded
    IsChunkLoaded { pos: crate::world_unified::core::ChunkPos },
    /// Get chunks in radius
    GetChunksInRadius { center: crate::world_unified::core::ChunkPos, radius: u32 },
...
impl InterfaceFactory {
    ...
    pub fn create_world_interface(
        manager: std::sync::Arc<std::sync::Mutex<crate::world_unified::management::UnifiedWorldManager>>
    ...
    pub fn create_generator_interface(
        generator: std::sync::Arc<crate::world_unified::generation::UnifiedGenerator>
...
mod tests {
    ...
    fn test_query_type_creation() {
        let query = QueryType::GetBlock { 
            pos: crate::world_unified::core::VoxelPos { x: 0, y: 0, z: 0 }
        };
