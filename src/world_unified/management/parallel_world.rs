...
impl ParallelWorld {
    ...
    pub async fn new(
        ...
        let manager_config = crate::world_unified::management::WorldManagerConfig {
    ...
    pub fn get_world_buffer(&self) -> Option<Arc<std::sync::Mutex<crate::world_unified::storage::WorldBuffer>>> {
...
impl crate::world_unified::interfaces::WorldInterface for ParallelWorld {
    fn get_block(&self, pos: VoxelPos) -> BlockId {
        let manager = self.manager.read();
        manager.get_block(pos)
    }
    
    fn set_block(&mut self, pos: VoxelPos, block_id: BlockId) -> Result<(), crate::world_unified::interfaces::WorldError> {
        let mut manager = self.manager.write();
        manager.set_block(pos, block_id)
            .map_err(|e| crate::world_unified::interfaces::WorldError::OperationFailed { 
    ...
    fn load_chunk(&mut self, chunk_pos: ChunkPos) -> Result<(), crate::world_unified::interfaces::WorldError> {
        let mut manager = self.manager.write();
    ...
    fn unload_chunk(&mut self, chunk_pos: ChunkPos) -> Result<(), crate::world_unified::interfaces::WorldError> {
    ...
    fn query(&self, query: crate::world_unified::interfaces::WorldQuery) -> Result<crate::world_unified::interfaces::QueryResult, crate::world_unified::interfaces::WorldError> {
        Err(crate::world_unified::interfaces::WorldError::OperationFailed {
    ...
    fn batch_operation(&mut self, operations: Vec<crate::world_unified::interfaces::WorldOperation>) -> Result<Vec<crate::world_unified::interfaces::OperationResult>, crate::world_unified::interfaces::WorldError> {
        Err(crate::world_unified::interfaces::WorldError::OperationFailed {
            message: "Query operation not implemented".to_string()
        })
    }
...
impl crate::world_unified::interfaces::UnifiedInterface for ParallelWorld {
    ...
    fn supports_capability(&self, capability: &str) -> bool {
        use crate::world_unified::interfaces::capabilities;
        match capability {
