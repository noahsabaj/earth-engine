...
// 
// NOTE: All GPU types and bindings are automatically provided by the unified system
// No manual includes needed!

// Include noise functions
#include "../rendering/perlin_noise.wgsl"

// NOTE: Bindings are auto-generated by unified system
...
fn generate_terrain(
    ...
    let chunk_x = i32((chunk_meta.flags >> 16u) & 0xFFFFu);
    let chunk_z = i32(chunk_meta.flags & 0xFFFFu);
    let chunk_y = i32(chunk_meta.y_position);
    let chunk_offset = vec3<i32>(chunk_x, chunk_y, chunk_z);
