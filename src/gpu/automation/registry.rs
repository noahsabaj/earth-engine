...
use crate::gpu::automation::{auto_layout::AutoLayout, auto_wgsl::AutoWgsl, UnifiedGpuSystem};
use crate::gpu::soa::{BlockDistributionSOA, TerrainParamsSOA};
use crate::gpu::types::weather::{
...
lazy_static! {
    ...
    pub static ref GPU_REGISTRY: Mutex<UnifiedGpuSystem> = {
        ...
        // Weather types
        system.register_type::<WeatherDataGpu>();
        system.register_type::<PrecipitationParticleGpu>();
        system.register_type::<WeatherTransitionGpu>();
        system.register_type::<WeatherConfigGpu>();
...
pub fn initialize_gpu_registry() {
    ...
    let registry = GPU_REGISTRY
        .lock()
        .expect("[GpuRegistry] Failed to acquire GPU registry lock");
...
pub fn create_gpu_shader(
    ...
    crate::gpu::automation::safe_pipeline::ValidatedShader,
    crate::gpu::automation::safe_pipeline::PipelineError,
> {
    let mut registry = GPU_REGISTRY
        .lock()
        .expect("[GpuRegistry] Failed to acquire GPU registry lock");
