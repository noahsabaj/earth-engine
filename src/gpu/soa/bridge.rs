...
use crate::gpu::soa::types::{SoaCompatible, BlockDistributionSOA, TerrainParamsSOA};
...
impl CpuGpuBridge {
    ...
    pub fn update_in_gpu<T: SoaCompatible>(
        gpu_data: &mut T::Arrays,
        index: usize,
        cpu_item: &T,
    ) {
