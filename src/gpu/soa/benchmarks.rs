...
use crate::gpu::soa::types::{BlockDistributionSOA, TerrainParamsSOA, SoaCompatible};
...
impl SoaBenchmarkSuite {
    ...
    pub fn bench_height_check(&self) -> SoaBenchmarkResults {
        ...
        let bandwidth_savings = 1.0 - (soa_metrics.memory_metrics.bytes_accessed as f32 
                                      / aos_metrics.memory_metrics.bytes_accessed as f32);
        let cache_improvement = soa_metrics.memory_metrics.efficiency 
                               - aos_metrics.memory_metrics.efficiency;
    ...
    fn bench_aos_height_check(
        ...
        let bytes_accessed = test_heights.len() as u64 * distributions.len() as u64 
                            * bytes_per_distribution as u64;
    ...
    fn bench_soa_height_check(
        ...
        let bytes_accessed = test_heights.len() as u64 * soa_data.count as u64 
                            * bytes_per_element as u64 * 2; // min + max arrays
    ...
    pub fn run_all(&self) -> SoaBenchmarkReport {
        ...
        log::info!("[SOA Benchmark] Iterations: {}, Data size: {}", 
...
impl SoaBenchmarkReport {
    ...
    pub fn summary(&self) -> String {
        format!(
            ...
            self.height_check_results.aos_metrics.memory_metrics.bytes_accessed / 1_000_000,
            self.height_check_results.soa_metrics.memory_metrics.bytes_accessed / 1_000_000,
            self.height_check_results.bandwidth_savings * 100.0,
        )
    }
}
