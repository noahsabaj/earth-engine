...
mod tests {
    ...
    fn test_atomic_write_creates_directories() {
        ...
        atomic_write(&nested_file, test_data)
            .expect("Atomic write should create directories and succeed");
    ...
    fn test_atomic_write_no_partial_files() {
        ...
        atomic_write(&test_file, b"second content that is much longer")
