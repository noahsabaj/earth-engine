    ...
    for y in 0..chunk_size {
        for z in 0..chunk_size {
            for x in 0..chunk_size {
                ...
                // Top face (Y+)
                if should_render_face(x as i32, y as i32 + 1, z as i32, chunk_size, &get_block, &get_neighbor_block) {
                    operations::add_quad(
                        buffer,
                        operations::BlockFace::Top,
                        world_x, world_y, world_z,
                        block,
                        calculate_face_light(x as i32, y as i32 + 1, z as i32, chunk_size, &get_neighbor_block),
                        calculate_face_ao(x as i32, y as i32 + 1, z as i32, operations::BlockFace::Top, chunk_size, &get_neighbor_block),
                    )?;
                }
                ...
                if should_render_face(x as i32, y as i32 - 1, z as i32, chunk_size, &get_block, &get_neighbor_block) {
                    operations::add_quad(
                        ...
                        block,
                        calculate_face_light(x as i32, y as i32 - 1, z as i32, chunk_size, &get_neighbor_block),
                        calculate_face_ao(x as i32, y as i32 - 1, z as i32, operations::BlockFace::Bottom, chunk_size, &get_neighbor_block),
                    )?;
                }
                
                // North face (Z-)
                if should_render_face(x as i32, y as i32, z as i32 - 1, chunk_size, &get_block, &get_neighbor_block) {
                    operations::add_quad(
                        buffer,
                        operations::BlockFace::North,
                        world_x, world_y, world_z,
                        block,
                        calculate_face_light(x as i32, y as i32, z as i32 - 1, chunk_size, &get_neighbor_block),
                        calculate_face_ao(x as i32, y as i32, z as i32 - 1, operations::BlockFace::North, chunk_size, &get_neighbor_block),
                    )?;
                }
                ...
                if should_render_face(x as i32, y as i32, z as i32 + 1, chunk_size, &get_block, &get_neighbor_block) {
                    operations::add_quad(
                        ...
                        block,
                        calculate_face_light(x as i32, y as i32, z as i32 + 1, chunk_size, &get_neighbor_block),
                        calculate_face_ao(x as i32, y as i32, z as i32 + 1, operations::BlockFace::South, chunk_size, &get_neighbor_block),
                    )?;
                }
                
                // East face (X+)
                if should_render_face(x as i32 + 1, y as i32, z as i32, chunk_size, &get_block, &get_neighbor_block) {
                    operations::add_quad(
                        buffer,
                        operations::BlockFace::East,
                        world_x, world_y, world_z,
                        block,
                        calculate_face_light(x as i32 + 1, y as i32, z as i32, chunk_size, &get_neighbor_block),
                        calculate_face_ao(x as i32 + 1, y as i32, z as i32, operations::BlockFace::East, chunk_size, &get_neighbor_block),
                    )?;
                }
                ...
                if should_render_face(x as i32 - 1, y as i32, z as i32, chunk_size, &get_block, &get_neighbor_block) {
                    operations::add_quad(
                        ...
                        block,
                        calculate_face_light(x as i32 - 1, y as i32, z as i32, chunk_size, &get_neighbor_block),
                        calculate_face_ao(x as i32 - 1, y as i32, z as i32, operations::BlockFace::West, chunk_size, &get_neighbor_block),
                    )?;
                }
            }
        }
...
pub fn chunk_distance_squared(chunk_pos: ChunkPos, view_pos: Vector3<f32>, chunk_size: u32) -> f32 {
    let chunk_center = chunk_world_position(chunk_pos, chunk_size) + 
                      Vector3::new(chunk_size as f32 / 2.0, chunk_size as f32 / 2.0, chunk_size as f32 / 2.0);
...
pub fn filter_visible_chunks(
    ...
    for &chunk_pos in chunks {
        ...
        if dist_sq <= max_dist_sq && is_chunk_in_frustum(chunk_pos, chunk_size, view_pos, view_dir, fov_cos) {
