...
use std::sync::Arc;
use crate::world::generation::{UnifiedGenerator, GeneratorConfig, BlockIds, TerrainParams};
...
#[cfg(feature = "legacy-world-modules")]
impl crate::world::generation::WorldGenerator for LegacyGeneratorAdapter {
    fn generate_chunk(&self, chunk_pos: crate::ChunkPos, chunk_size: u32) -> crate::world::storage::ChunkSoA {
    ...
    fn get_world_buffer(&self) -> Option<std::sync::Arc<std::sync::Mutex<crate::world::storage::WorldBuffer>>> {
...
pub fn create_legacy_gpu_generator(
    ...
    water_id: crate::BlockId,
    sand_id: crate::BlockId,
) -> Box<dyn crate::world::generation::WorldGenerator + Send + Sync> {
